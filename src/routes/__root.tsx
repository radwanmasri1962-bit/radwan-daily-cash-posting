...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Radwan Daily Cash Position" },
      { name: "description", content: "Simple manual-entry daily cash tracker for personal finances." },
      { name: "author", content: "Radwan Daily Cash Position" },
      { property: "og:title", content: "Radwan Daily Cash Position" },
      { property: "og:description", content: "Simple manual-entry daily cash tracker for personal finances." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Radwan Daily Cash Position" },
